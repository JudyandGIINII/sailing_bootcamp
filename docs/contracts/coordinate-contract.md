...
모든 scenario는 contract version, origin, map bounds, synthetic depth datum, unit labels, declared wind/current semantics, permitted coordinate transforms를 가진다. 누락·unknown version·compatible하지 않은 convention은 load failure다.
